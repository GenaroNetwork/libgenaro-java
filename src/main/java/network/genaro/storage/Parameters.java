...
final class Parameters {
    public static final int GENARO_OKHTTP_CONNECT_TIMEOUT = 15;
    public static final int GENARO_OKHTTP_WRITE_TIMEOUT = 30;
    public static final int GENARO_OKHTTP_READ_TIMEOUT = 60;
