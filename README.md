...
Asynchronous Java library and CLI for encrypted file transfer on the Genaro network written in Java 8. It's Compatible with [libgenaro](https://github.com/GenaroNetwork/libgenaro).
